...
"use strict";function _interopRequireWildcard(r){if(r&&r.__esModule)return r;var e={};if(null!=r)for(var t in r)Object.prototype.hasOwnProperty.call(r,t)&&(e[t]=r[t]);return e.default=r,e}function _toConsumableArray(r){if(Array.isArray(r)){for(var e=0,t=Array(r.length);e<r.length;e++)t[e]=r[e];return t}return Array.from(r)}function makeAPI(r){for(var e in r)!function(e){!function(){if("function"==typeof r[e]){var t=function(){return new(Function.prototype.bind.apply(i,[null].concat(Array.prototype.slice.call(arguments))))},i=r[e],n=[].concat(_toConsumableArray(Object.getOwnPropertyNames(r[e]))).filter(function(r){return!(r in Function())}),a=!0,o=!1,u=void 0;try{for(var c,l=n[Symbol.iterator]();!(a=(c=l.next()).done);a=!0){var m=c.value;null==t[m]&&(t[m]=r[e][m])}}catch(r){o=!0,u=r}finally{try{!a&&l.return&&l.return()}finally{if(o)throw u}}Object.defineProperty(exports,e,{get:function(){return t}})}else Object.defineProperty(exports,e,{get:function(){return r[e]}})}()}(e)}var _core=_dereq_("./core"),core=_interopRequireWildcard(_core),_mesh=_dereq_("./mesh"),mesh=_interopRequireWildcard(_mesh),_math=_dereq_("./math"),math=_interopRequireWildcard(_math),_input=_dereq_("./input"),input=_interopRequireWildcard(_input),_light=_dereq_("./light"),light=_interopRequireWildcard(_light),_cameras=_dereq_("./cameras"),cameras=_interopRequireWildcard(_cameras),_material=_dereq_("./material"),material=_interopRequireWildcard(_material),_geometry=_dereq_("./geometry"),geometry=_interopRequireWildcard(_geometry);[core,mesh,math,input,light,cameras,material,geometry].forEach(makeAPI);
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var kMaxAmbientLights=exports.kMaxAmbientLights=16,kMaxDirectionalLights=exports.kMaxDirectionalLights=16,kMaxPointLights=exports.kMaxPointLights=16;
